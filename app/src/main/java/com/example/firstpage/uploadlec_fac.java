...
public class uploadlec_fac extends AppCompatActivity {
    private DrawerLayout d1;
    private ActionBarDrawerToggle abdt;
    TextView txt1,txt2,txt3,txt4,txt5;
    Button addbutton,viewbutton,deletebutton,findbutton,file,choose;
    EditText stuID;
    EditText passwd;
    TextView lst;
    TextView name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadlec_fac);
...
//        file = (Button) findViewById(R.id.butt6);
        //choose = (Button) findViewById(R.id.butt7);

        file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                fileUpload(path.getText().toString());
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id==R.id.home)
                {
                    Toast.makeText( uploadlec_fac.this,"home",Toast.LENGTH_SHORT).show();
                    openhome();
                }
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(uploadlec_fac.this, "Permission denied to read your External storage", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    {
        ActivityCompat.requestPermissions(uploadlec_fac.this,
